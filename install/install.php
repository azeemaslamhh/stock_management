...
if (is_file($installFile)) {
    ...
    switch ($step) {
        ...
        <h3>Pre-Install Checklist</h3>
            ...
            if (phpversion() < '7.4' && phpversion() >= '8.1') {
                $error = true;
                echo "<div class='alert alert-error'><i class='icon-remove'></i> Your PHP version is " . phpversion() . '! PHP7.4 or php8.0 is required!</div>';
            } else {
