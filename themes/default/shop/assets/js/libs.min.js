	...
	c.fn.stick_in_parent = function(b) {
		...
		J = function(a, b, n, C, F, u, r, G) {
			...
			if (!a.data("sticky_kit")) {
				...
				x = function() {
					var d, f, e;
					if (!G && (I = A.height(), d = parseInt(g.css("border-top-width"), 10), f = parseInt(g.css("padding-top"), 10), b = parseInt(g.css(""), 10), n = g.offset().top + d + f, C = g.height(), m && (v = m = !1, null == p && (a.insertAfter(h), h.detach()), a.css({
							position: "",
							top: "",
							width: "",
							bottom: ""
